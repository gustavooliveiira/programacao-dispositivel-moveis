...
const styles = StyleSheet.create({
    ...
    item: {flexDirection: "row", alignItems: "center", backgroundColor: "#FFFFFF",
        paddingHorizontal: 16, paddingVertical:12, marginBottom: 8, height:56, 
    },

    itemAvatar: { width: 40, height: 40, borderRadius: 20, marginRight: 16, 
    },
    
    itemName: {fonteSize:14, color: "#1C1B1F",
    },

    itemPhone:{fonteSize: 14, color: "#49454F",
    },
